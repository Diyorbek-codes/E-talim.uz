...
use App\Http\Controllers\ohtm_uquv_bulimi\UqituvchiYuklamaController;
...
Route::group(['prefix'=>'uquvbulumi', 'as'=>'uquvbulumi.', 'middleware'=>'faol'], function(){
    ...
    //Uqituvchilar yuklamasi
    Route::get('/uqituvchi_yuklama/{id}', [UqituvchiYuklamaController::class, 'index'])->name('uqituvchi_yuklama.index');
    ...
    Route::get('/qayta_topshirish/{videmost_id}', [QaytaTopshirishController::class, 'index'])->name('qayta_topshirish.index');
