...
use App\Http\Controllers\ohtm_uqituvchi\ParolYangilashController;
...
//    uqituvchi_fanlar uchun
    ...
    //    Parolni_yangilash
    Route::get('/parolni_yangilash', [ParolYangilashController::class, 'index'])->name('parolni_yangilash.index');
//    Route::post('/parolni_yangilash/{id}/change-password', [ParolYangilashController::class, 'changePassword'])->name('parolni_yangilash.password');
    Route::post('/parolni_yangilash/{id}/updatePassword', [ParolYangilashController::class, 'updatePassword'])->name('parolni_yangilash.update_password');
